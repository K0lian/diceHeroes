 ...
 */
public class BraidResult implements IActionResult {
    ...
    public BraidResult(Creature creature, Array<IActionResult> results, Array<Creature> targets, AttackType attackType, int attackLevel) {
